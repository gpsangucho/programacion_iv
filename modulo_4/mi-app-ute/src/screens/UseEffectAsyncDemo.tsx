  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        const res = await fetch("https://jsonplaceholder.typicode.com/todos?_limit=5"); //Para hacer peticiones nativas de java script, a una API
        const data = (await res.json()) as TodoDTO[];

        console.log('todos',res.json());
