...
class _ResumenPageState extends State<ResumenPage> {
  ...
  void _calculateCredits() {
    ...
    for (int i = 0; i < subjectsCount; i++) {
      ...
      lines.add('- $name: $credits Consumo: ');
    }
    ...
    if (totalCredits < 200) {
      ...
      loadType = 'Día aceptable';
    } else {
      loadType = 'Dias excelente';
    }
    ...
    setState(() {
      resultText =
        ...
        '${lines.join('\n')}\n\n'
        'Total servicios: $totalCredits\n'
        'Tipo de día: $loadType';
    });
  }
            ...
            children: [
              ...
              TextField(
                decoration: const InputDecoration(
                  labelText: 'Cantidad de servicio del día (1 - 8)',
              ...
              ElevatedButton(
                ...
                child: const Text('Generar servicios del día'),
              ),
              ...
              if (subjectsCount > 0)
                ElevatedButton(
                  ...
                  child: const Text('Calcular servicios totales'),
                ),
