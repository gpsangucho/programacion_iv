...
class _TipPageState extends State<TipPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Calificación de Servicio y aporte para ayuda veterinaria'),
        leading: IconButton(
          ...
          children: [
            ...
            DropdownButton<String>(
              ...
              items: const [
                ...
                DropdownMenuItem(
                  value: 'Bueno',
                  child: Text('Buena atención'),
                ),
                DropdownMenuItem(
                  value: 'Excelente',
                  child: Text('Excelente atención'),
                ),
              ],
              onChanged: (value) {
            ...
            ElevatedButton(
              ...
              child: const Text('Calcular aporte'),
            ),
