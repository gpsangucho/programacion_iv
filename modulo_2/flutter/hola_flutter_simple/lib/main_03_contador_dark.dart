...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // ******DEFINICIÓN DEL RETORNO... MaterialApp es la APP completa: aplica el tema y ejecuta COuterPage()
    return MaterialApp(
      title: 'Flutter Dark Counter',
      debugShowCheckedModeBanner: false,
      theme: theme,                 // Aplica el temal a la página
      home: const CounterPage(),   //Define el contenido de la página principal: Ejecuta el CounterPage()
    );
  }
}

//**********Pantalla principal: Cambia el estado */
