...
fun ListaEditableScreen() {
    ...
    val usuarios = remember {
        mutableStateListOf(
            Usuario2(1, "Ana Torres", "Diseñadora"),
            Usuario2(2, "Luis Pérez", "Desarrollador"),
            Usuario2(3, "María López", "Tester QA"),
            Usuario2(4, "Carlos Ruiz", "Project Manager")
        )
    }
    ...
    var seleccionado by remember { mutableStateOf(null) }
            ...
            Button(
                onClick = {
                    ...
                    if (n.isNotEmpty() && r.isNotEmpty()) {
                        autoId += 1
                        usuarios.add(Usuario2(autoId, n, r))
                        nombre = ""; rol = ""
                    }
                },
